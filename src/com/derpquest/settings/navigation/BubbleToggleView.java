...
import com.derpquest.settings.navigation.ViewUtils;
        ...
        if (attrs != null) {
            ...
            try {
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP)
                    icon = ta.getDrawable(R.styleable.BubbleToggleView_derp_icon);
                else
                icon = AppCompatResources.getDrawable(getContext(), ta.getResourceId(R.styleable.BubbleToggleView_derp_icon, R.drawable.default_icon));
                iconWidth = ta.getDimension(R.styleable.BubbleToggleView_derp_iconWidth, iconWidth);
                iconHeight = ta.getDimension(R.styleable.BubbleToggleView_derp_iconHeight, iconHeight);
                shape = ta.getDrawable(R.styleable.BubbleToggleView_derp_shape);
                shapeColor = ta.getColor(R.styleable.BubbleToggleView_derp_shapeColor, shapeColor);
                showShapeAlways = ta.getBoolean(R.styleable.BubbleToggleView_derp_showShapeAlways, false);
                title = ta.getString(R.styleable.BubbleToggleView_derp_title);
                titleSize = ta.getDimension(R.styleable.BubbleToggleView_derp_titleSize, titleSize);
                colorActive = ta.getColor(R.styleable.BubbleToggleView_derp_colorActive, colorActive);
                colorInactive = ta.getColor(R.styleable.BubbleToggleView_derp_colorInactive, colorInactive);
                isActive = ta.getBoolean(R.styleable.BubbleToggleView_derp_active, false);
                animationDuration = ta.getInteger(R.styleable.BubbleToggleView_derp_duration, DEFAULT_ANIM_DURATION);
                internalPadding = (int) ta.getDimension(R.styleable.BubbleToggleView_derp_padding, internalPadding);
                titlePadding = (int) ta.getDimension(R.styleable.BubbleToggleView_derp_titlePadding, titlePadding);
            } finally {
                ta.recycle();
            }
        }
